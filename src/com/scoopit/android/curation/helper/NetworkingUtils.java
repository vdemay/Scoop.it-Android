package com.scoopit.android.curation.helper;
...
public class NetworkingUtils {
	...
	public static String sendRestfullPostRequest(String url,
			OAuthConsumer consumer, Map<String, String> params) {
	...
	public static String sendRestfullPostRequest(String url,
			OAuthConsumer consumer, List<NameValuePair> httpParams) {
		try {
			DefaultHttpClient httpclient = new DefaultHttpClient();
	...
	public static String uploadImage(OAuthConsumer consumer, Bitmap image) {
		try {
			...
			DefaultHttpClient httpclient = new DefaultHttpClient();
			HttpPost request = new HttpPost(Constants.UPLOAD_IMAGE_REQUEST);
			...
			BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(responseData));
			String responseLine;
			StringBuilder responseBuilder = new StringBuilder();
			while ((responseLine = bufferedReader.readLine()) != null) {
				responseBuilder.append(responseLine);
